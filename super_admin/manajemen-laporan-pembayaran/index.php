...
<body>
    <div class="sidebar">
        ...
        <a href="./index.php" >Manajemen Pemesanan</a>
        ...
        <a href="../manajemen-laporan-pembayaran/index.php" class="active">Manajemen laporan Pembayaran</a>
    ...
    <div class="content">
        ...
        <h2>Halaman Manajemen Laporan Pembayaran</h2>
    </div>
</body>
</html>