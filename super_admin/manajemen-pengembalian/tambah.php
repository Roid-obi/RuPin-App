...
// Ambil data booking untuk select option
...
<div class="content">
    ...
    <form method="POST" enctype="multipart/form-data" class="mt-3">
        <div class="mb-3">
            ...
            <select name="booking_id" id="booking_id" class="form-control" required>
                ...
                <?php while ($row = $booking_result->fetch_assoc()): ?>
                    <option value="<?= $row['booking_id'] ?>">Booking #<?= $row['booking_id'] ?> - <?= htmlspecialchars($row['item_nama']) ?></option>
                <?php endwhile; ?>
            </select>
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="number" step="0.01" name="denda" id="denda" class="form-control">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3 d-flex ">
            <button type="submit" class="btn btn-primary me-2"><i class="fa fa-save"></i> Simpan</button>
